    ...
    public TreeVisitor<?, ExecutionContext> getVisitor() {
        return Preconditions.check(
                or(
                        ...
                        new UsesMethod<>(IS_INFO_ENABLED),
                        new UsesMethod<>(IS_WARN_ENABLED),
                        new UsesMethod<>(IS_ERROR_ENABLED),
                        new UsesMethod<>(IS_TRACE_ENABLED_MARKER),
                        new UsesMethod<>(IS_DEBUG_ENABLED_MARKER),
                        new UsesMethod<>(IS_INFO_ENABLED_MARKER),
                        new UsesMethod<>(IS_WARN_ENABLED_MARKER),
                        new UsesMethod<>(IS_ERROR_ENABLED_MARKER)
                ),
