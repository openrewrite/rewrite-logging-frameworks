...
class CommonsLoggingToLog4jGroovyTest
    implements RewriteTest {
    @Override
    public void defaults(RecipeSpec spec) {
        spec.recipeFromResource("/META-INF/rewrite/log4j.yml",
            "org.openrewrite.java.logging.log4j.CommonsLoggingToLog4j")
          .parser(GroovyParser.builder().classpathFromResource(new InMemoryExecutionContext(), "log4j-api-2.+", "commons-logging-1.3.+", "lombok-1.18.+"));
    }
